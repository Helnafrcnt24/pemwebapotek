            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <a data-toggle="tooltip" data-placement="top" title="edit" class="btn btn-secondary btn-sm" href="index.php?page=edit_barang&edit=<?php echo $data['ID_BARANG']; ?>&ruang=<?php echo $data['ID_JENIS'];?>"  onclick="return confirm('apakah anda yakin untuk edit <?php echo $data['NAMA_JENIS']; ?> ?')">
                                <i class=" fas fa-edit"></i>
                            </a>
                            <a data-toggle="tooltip" data-placement="top" title="delete" class="btn btn-danger btn-sm" href="index.php?page=barang&delete=<?php echo $data['ID_BARANG']; ?>" onclick="return confirm('apakah anda yakin untuk delete <?php echo $data['NAMA']; ?> ?')">
